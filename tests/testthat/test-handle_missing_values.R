...
#     example_proteome_matrix <- data(example_proteome_matrix)
...
#                     fixed = TRUE
#                 ),
#                 "removing rows with all values missing",
#                 fixed = TRUE
#             ),
#             "warn",
#             fixed = TRUE
...
# test_that("non-numeric fill leaves matrix unchanged", {
#     example_proteome_matrix <- data(example_proteome_matrix)
#     mat <- example_proteome_matrix[8:10, 1:3]
#     expect_warning(
#         expect_warning(
