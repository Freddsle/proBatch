...
dataset is used (400 protein groups with 1463 matched precursors).
...
```{r plot_pca_combat_series, fig.height=7, fig.show='hold', fig.width=8, message=FALSE, warning=FALSE}
plot_PCA(
    pbf,
    pbf_name = c(
        "protein::log2_on_raw",
...
or UMAP:
```{r plot_umap_combat_series, fig.height=7, fig.show='hold', fig.width=8, message=FALSE, warning=FALSE}
plot_UMAP(
    pbf,
    pbf_name = c(
        "protein::log2_on_raw",
...
```{r plot_pvca_panels, fig.height=6, fig.show='hold', fig.width=11, message=FALSE, warning=FALSE}
plot_PVCA(
    pbf,
    pbf_name = c(
        "protein::log2_on_raw",
