...
# +
    # ggtitle("Before Median Normalization, protein level")
...
p2 <- plot_boxplot(
    ...
    color_scheme = color_scheme,
    base_size = 7,
    pbf_name = "protein::medianNorm_on_log2_on_raw"
) 
# +
#     ggtitle("After Median Normalization, protein level")
...
pca2 <- plot_PCA(
    ...
    fill_the_missing = -1, # default value
    # plot_title = "NA replaced with -1, protein, log2",
    base_size = 10, point_size = 2, point_alpha = 0.5
)
